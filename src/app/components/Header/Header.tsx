        ...
        <div className='Header w-screen h-[60px] px-10 flex items-center relative z-20 lg:justify-end lg:px-20'>
            ...
            <div className={`nav ${hideMenu && "hidden"} flex lg:flex lg:gap-52`}>
                <div className="nav1 flex gap-20 lg:flex">
                    ...
                    <Link className='linkTag' href={''} onClick={handleMenu}>Contact</Link>
                </div>
                <div className="nav2 flex gap-10 lg:flex">
                    <Link href={''} className='linkTag flex gap-3' onClick={handleMenu}><i className="fa-solid fa-user"></i> <span className='block lg:hidden'>User Account</span> </Link>
            ...
            {/* =============================== cart drop down Flag =========================== */}
            {
               ...
               <div className="cartFlag">
                    ...
                    <div className="items flex gap-2">
                        <div className="image w-[100px] h-[70px]"><img className=' w-[100%] h-[100%]  object-contain' src="/images/asgaard_sofa.png" alt="" /></div>
                        <div className="text">
                            <h1>Asgaard Sofa</h1>
                            <p>1 x Rs.250,000</p>
                        </div>
                    ...
                    <button className='w-[130px] h-[30px] border border-black rounded-3xl flex justify-center items-center'>View Cart</button>
                    <button className='w-[130px] h-[30px] border border-black rounded-3xl flex justify-center items-center'>Checkout</button>
                    </div>
                </div>
}
        </div>
